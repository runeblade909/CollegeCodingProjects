...
Kpt = 25;           %Proportional gain theta
...
Sim_Time = 20;       %[Seconds] Simulation run time
saturation = 10;    %[Volts] Motor saturation voltage. Default = 10
Amplitude = 0.25;    %[Rads] Amplitude of hub reference step command
Frequency = 0.175;    %[Hz] Frequency of hub reference step command
