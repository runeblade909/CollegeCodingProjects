function x = odeSimControlled(t,s,C,V_lat,V_long)
g = C{1}; m = C{2}; R = C{3}; km = C{4}; Ix = C{5}; Iy = C{6}; Iz = C{7};
vCoef = C{8}; mu = C{9}; k1_lat = C{10}; k2_lat = C{11}; k1_long = C{12}; 
k2_long = C{13}; k3_long = C{14}; k3_lat = C{15};
   ...
   MomentControl = [-k1_lat*s(10)-k2_lat*s(4) + k3_lat*(V_lat-s(8));-k1_long*s(11)-k2_long*s(5)+k3_long*(V_long-s(7)); -0.004*s(12)]; % control moment
   ...
   eq_4 = fourthEq(Ix,Iy,Iz,s(10),s(11),s(12),L,M,N,MomentControl(1),MomentControl(2),MomentControl(3)); 
