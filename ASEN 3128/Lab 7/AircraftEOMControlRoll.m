function xdot = AircraftEOMControlRoll(t,aircraft_state,aircraft_surfaces0,wind_inertial,aircraft_parameters,inner,ka,kp)
...
aircraft_surfaces = aircraft_surfaces0 + [0; delta_a; 0; 0];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
