function xdot = quadrotorODE_controlled(t,state_vec,m,I_x,I_y,I_z,n,mu,Z_c,L_c,M_c,N_c)
    ...
    MCntl = -0.004*[p;q;r]; % control moment 
    ...
    a_angular = [((I_y-I_z)/I_x)*q*r; ((I_z-I_x)/I_y)*q*r; ((I_x-I_y)/I_z)*q*r]...
        ...
        + [(1/I_x)*MCntl(1); (1/I_y)*MCntl(2); (1/I_z)*MCntl(3)];
    deltaF = [0; -0.004*a_angular];
    
    xdot = [v_inertial; euler_dot; a_inertial; a_angular; deltaF]; % vecotr output for the integrals
