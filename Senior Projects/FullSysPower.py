...
#c = RTG trade (2 option)
#d = Orbit trade (4 options)

import numpy
import numpy as np

#j/s --> watt j/12*3600
#b 0-3 different blends of architecture
#a 0-1 battery
#c 0-1 number of RTGs
#d 0-3 orbits

def Power_Trades(Dist_Pwr, Dist_energy, Processing_Pwr, Processing_energy, a, b, c, d):
    ...
    Orbit_Pwr, Orbit_Fuel, Orbit_Cost, Orbital_Lifetime = orbit(Orbital_Solar_Req,d)
    ...
    Fuel = 0
    Cost = GS_cost + Battery_Cost + RTG_Cost + Orbit_Pwr
    Efficiency = Power
